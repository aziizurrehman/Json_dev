...
const Service = require("../services/accountBalanceService");
...
//Header Validation
 const authRes = Authenticator.authenticate(req);
  ...
  const logger = CommonDebugLoggerInstance.CommonDebugLogger(commonHeaders,"accountBalanceController.js")
